...
describe('common: getSurroundingCells', () => {
  it('snake is in top left corner', () => {
  ...
  it('snake is in top right corner', () => {
  ...
  it('snake is in bottom right corner', () => {
  ...
  it('snake is in bottom left corner', () => {
